...
<!-- PROJECT SHIELDS -->
![Static Badge](https://img.shields.io/badge/SWL-Callouts?style=plastic&logo=github&link=https://github.com/Scottywonderful)
![GitHub Tag](https://img.shields.io/github/v/tag/Scottywonderful/SWL-Callouts?include_prereleases&style=plastic&logo=Github&label=Release&link=https://github.com/Scottywonderful/SWL-Callouts/releases/latest)
...
<h3 align="center">SWLCallouts (Build 0.4.8.7)</h3>
...
## <span style="color:lightblue">This plugin was built with:</span>
...
## <span style="color:lightblue">Message from the creator</span>
Hello there,<br>
...
<b><span style="color:yellow">Callouts listed below are coming soon.</span></b>
  * Traffic stop backup<br><br>

<b><span style="color:orange">Callouts listed below are currently in progress.</span></b>
  * Armed terrorist attack<br><br>

<b><span style="color:darkred">Callouts listed below are planned sometime in the future.</span></b><br>
  * Active pursuit
  * Active shooter
  * Apartment burglary
  * Armed clown
...
### <span style="color:purple">Customization</span>
...
<!-- GETTING STARTED -->
## <span style="color:lightblue">Getting Started</span>
...
#### <span style="color:pink">Recommended plugins</span>
...
3. Commit your Changes (`git commit -m 'Add an AwesomeFeature'`)
