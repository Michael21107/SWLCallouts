        ...
        public override void Process()
        {
            GameFiber.StartNew(delegate
            {
                if (SpawnPoint.DistanceTo(Game.LocalPlayer.Character) < 50f)
                {
                    ...
                    {
                        if (Scene1 == true && Suspect && Suspect.DistanceTo(Game.LocalPlayer.Character) < 25f && (!Game.LocalPlayer.Character.IsInAnyVehicle(false) || Game.LocalPlayer.Character.IsOnFoot) && !notificationDisplayed && !getAmbulance)
                        ...
                        if (Scene2 == true && SpawnPoint.DistanceTo(Game.LocalPlayer.Character) < 20f && (!Game.LocalPlayer.Character.IsInAnyVehicle(false) || Game.LocalPlayer.Character.IsOnFoot) && !notificationDisplayed)
                        {
                        ...
                        if (Scene3 == true && Suspect && Suspect.DistanceTo(Game.LocalPlayer.Character) < 25f && (!Game.LocalPlayer.Character.IsInAnyVehicle(false) || Game.LocalPlayer.Character.IsOnFoot) && alreadySubtitleIntrod == false)
                        {
