...
class SWLStolenEmergencyVehicle2 : Callout
{
    ...
    public override bool OnCalloutAccepted()
    {
        ...
        NotifyP("3dtextures", "mpgroundlogo_cops", "~w~SWLCallouts", "~b~Dispatch", SEV2DispatchArrive.PickRandom());
    ...
    public override void End()
    {
        ...
        NotifyP("3dtextures", "mpgroundlogo_cops", "~b~DISPATCH", "~y~Stolen Emergency Vehicle", SEV2DispatchCode4.PickRandom());
