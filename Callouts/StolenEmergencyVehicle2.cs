...
namespace SWLCallouts.Callouts
{
    ...
    class SWLStolenEmergencyVehicle2 : Callout
    {
        ...
        private readonly string[] emVehicles = new string[] { "AMBULANCE", "FIRETRUK", "lguard", "riot", "riot2" };
        ...
        {
            Game.LogTrivial("SWLCallouts Log: Stolen Emergency Vehicle2 callout accepted.");

            EmergencyVehicle = new Vehicle(emVehicles[new Random().Next((int)emVehicles.Length)], SpawnPoint);
