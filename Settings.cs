...
internal static class Settings
{
    ...
    internal static void LoadSettings()
    {
        ...
        // Settings Below //
        Department = ini.ReadString("Settings", "Department", "SWLCO"); // Default to SWLCallout Logo department if not specified //
    ...
    public static readonly string PluginVersion = "0.4.6.0";
